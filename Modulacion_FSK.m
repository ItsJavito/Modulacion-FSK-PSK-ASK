...
%XXXXXXXXXXXXXXXXXXXXXXX Modulación FSK-binaria XXXXXXXXXXXXXXXXXXXXXXXXXXX%
...
xlabel('tiempo(seg)');
ylabel('amplitud(volt)');
title('Forma de onda para la modulación FSK correspondiente a los Datos binarios');
